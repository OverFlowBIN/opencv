...
def ocr_project_clova():
    
    
    api_url = 'https://wdckbxsl6h.apigw.ntruss.com/custom/v1/27360/39b1fd85a80dfc3ff359841d82b222045e06bb0411010ecc603e76e16b62f923/general'
    secret_key = 'Y3VSaWlEclhzQ2VDQnZFUURTSWZXSXFKdmR1Y2VWRmg='
    # image_url = 'https://ocr.selvasai.com/img/sample_idcard.png'
    image_file = 'images/idcard_16.jpeg'
...
def auto_scan_image():
    ...
    image = cv2.imread('images/idcard_2.jpeg')
    orig = image.copy()
...
#         im.show()
#         ocr_project_clova(headers, params, data)
